        ...
        <ul class="list0" style="display: none">
            ...
            <li class="col-xs-12">
                ...
                <div class="col-lg-10 col-md-7 col-sm-8 col-xs-12">
                    ...
                    <p class="text-muted">
                        Existem muitas variações das passagens do Lorem Ipsum disponíveis, mas a maior parte sofreu alterações de alguma forma, pela injecção de humor, ou de palavras aleatórias que nem sequer parecem suficientemente credíveis. Se vai usar uma passagem do Lorem Ipsum, deve ter a certeza que não contém nada
                    </p>
...
<!--=========================================================
VITRINE DE PRODUTOS MAS VENDIDOS
==========================================================-->
<div class="container-fluid productos">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 tituloDestacado">
                <!--=========================================-->
                <div class="col-sm-6 col-xs-12">
                    <h1><small>MAS VENDIDOS</small></h1>
                </div>
